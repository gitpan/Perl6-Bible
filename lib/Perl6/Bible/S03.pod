...
Synopsis_3 - Summary of Perl 6 Operators
...
C<till> operator.  (C<..> now always produces a Range object
even in scalar context.)  The C<till> operator may take a caret on
either end to exclude either the beginning or ending.
