...
=item I<Diamond lives (context-aware);>

=item I<Underscore space means concatenate; fat comma means pair;>

=item I<A pre-star will flatten; colon-equals will bind;>

=item I<And binary slash-slash yields left-most defined.>

=over

=item -- Sade, "Smooth operator" (Perl 6 remix)
...
information, and write them back to disk.
...
To do this, we give the C<is prec> trait a reference to teh existing
